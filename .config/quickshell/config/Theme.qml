...
Singleton {
  ...
  JsonAdapter {
    ...
    property JsonObject rightSidebar: JsonObject {
      property color mainBg: root.rgba(30, 30, 46, 0.9)
      property color mainFg: root.rgba(180, 190, 254, 1)
      property color borderColor: root.rgba(150, 75, 255, 0.4)
      property color sectionBg: root.rgba(50, 255, 255, 0.3)
    ...
    property JsonObject notifications: JsonObject {
      property color mainBg: root.rgba(30, 30, 46, 0.8)
      property color mainFg: root.rgba(180, 190, 254, 1)
      property color borderColor: root.rgba(75, 75, 250, 0.4)
    }
  }
}
